...
# Indicador: Share of solid waste recycled (%)

# Mudar 3 últimos gráficos para - gráfico linhas (evolução temporal): reciclagem apenas.
                                # gráfico barras (ranking): reciclagem. donut (por cidade): obter percentagem reciclagem.
